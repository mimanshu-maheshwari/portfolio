...
import { AfterViewInit, Component, CUSTOM_ELEMENTS_SCHEMA, ElementRef, OnInit, Inject, ViewChild } from '@angular/core';
...
@Component({
  selector: 'app-header',
  standalone: true,
  imports: [NgbCollapseModule, CommonModule, MatSlideToggleModule, MatIconModule],
...
export class HeaderComponent implements OnInit, AfterViewInit {
  ...
  isDarkMode!: boolean; // Controls the theme
  ...
  ngAfterViewInit(): void {
    if (this.element) {
      let trackElement = this.element.nativeElement.querySelector('.mdc-switch__track');
      if (trackElement) {
